...
public final class OverviewWeek extends CalmanPeriod {
  ...
  public static OverviewWeek build(Calendar cal, Properties dbProps, CalmanUser currentUser) {
    ...
    return new OverviewWeek(firstDay, lastDay, dateList, dateMap, dbProps, currentUser);
  }

  private OverviewWeek(Calendar firstDay, Calendar lastDay, ArrayList dateList, HashMap dateMap, Properties dbProps, CalmanUser currentUser) {
