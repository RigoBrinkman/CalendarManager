...
import com.brinkbros.Overview.OverviewMonth;
            ...
            protected void populateItem(Item<ArrayList<CalmanDate>> item) {
                ...
                item.add(new DataView<CalmanDate>(DAY_ROW_ID, new ListDataProvider(month)) {
                    ...
                    protected void populateItem(Item<CalmanDate> item) {
                        ...
                        item.add(new Label(DAY_NO_ID, String.valueOf(date.getCalendar().get(Calendar.DAY_OF_MONTH))));
                        item.add(new DataView<DateEvent>(EVENTS_CELL_ID, new ListDataProvider(date.getEvents())) {
                            @Override
